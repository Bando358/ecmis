...
import { PecVih } from "@/lib/generated/prisma";
...
export default function VisitePecVihUpload() {
  ...
  const handlePushData = async () => {
    ...
    for (let index = 1; index < jsonData.length; index++) {
      const element = client.find((el) => el.codeVih === tabCode[index]);
  ...
  return (
    <div className="max-w-lg mx-auto mt-10">
      ...
      {selectedFile && (
        <p className="mt-4 bg-gradient-to-r from-green-600 to-yellow-500 bg-clip-text">
        ...
        <div className="mt-6 overflow-x-auto border rounded-lg shadow">
          ...
          <div className="my-4 text-center">
            ...
            {existeJsonData.length > 0 && (
              <p className="mt-4 bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text">
