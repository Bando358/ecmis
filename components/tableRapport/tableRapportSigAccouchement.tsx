        ...
        <TableBody>
          {tabLieuAccouchement.map((item) => (
            <TableRow key={item.label}>
              <TableCell
                className=" border border-gray-400 break-words whitespace-normal overflow-hidden"
        ...
        <Table className="table-auto w-full">
          ...
          <TableBody>
            {tabVaccination.map((item) => (
              <TableRow key={item.label}>
                <TableCell
                  className="border border-l-gray-400 break-words whitespace-normal overflow-hidden"
                  style={{
                    width: "400px",
                    minWidth: "400px",
                    maxWidth: "400px",
          ...
          <TableBody>
            {(() => {
              ...
              return tabNaissance.map((item) => (
                <TableRow key={item.label}>
                  <TableCell className="border border-l-gray-400 break-words whitespace-normal overflow-hidden">
                    {item.label}
                  </TableCell>
                  <TableCell className="text-center border font-semibold border-l-gray-400 border-r-gray-400">
