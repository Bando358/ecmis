...
import { FactureExamen, ResultatExamen } from "@/lib/generated/prisma";
          ...
          <Table className="border">
            ...
            <TableBody>
              ...
              <TableRow className="bg-gray-100">
                <TableCell
                  className="border border-l-gray-400 font-bold break-words whitespace-normal overflow-hidden"
                  style={{
                    width: "350px",
                    minWidth: "350px",
                    maxWidth: "350px",
