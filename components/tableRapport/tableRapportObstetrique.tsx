...
export default function TableRapportObstetrique({
  ...
  const exportToPdf = async () => {
    ...
    try {
      ...
      doc.setFontSize(16);
      doc.setFont("helvetica", "bold");
      doc.text("Rapport Obstétrique / CPON / Maternité", pageWidth / 2, currentY, { align: "center" });
      currentY += 8;
      ...
      const headers = [["Indicateurs", "-10 ans", "10-14 ans", "15-19 ans", "20-24 ans", "25+ ans", "Total"]];
      ...
      // 1. Tableau clients Avant/Après l'accouchement
      addTitle("Rapport clients reçus Avant/Après l'accouchement");
      autoTable(doc, {
        startY: currentY,
        head: headers,
        body: generateTableData(tabClientObstetrique),
        styles: tableStyles,
      ...
      // 3. Tableau clients Maternité
      checkPageBreak(60);
      addTitle("Rapport Clients reçus Maternité");
      autoTable(doc, {
        startY: currentY,
        head: headers,
        body: generateTableData(tabClientMaternite),
        styles: tableStyles,
        headStyles: headStyles,
        columnStyles: { 0: { halign: "left" } },
        pageBreak: "avoid",
      ...
      doc.save(`Rapport_Obstetrique_${new Date().toLocaleDateString("fr-FR")}.pdf`);
    } finally {
      setSpinnerPdf(false);
    }
  };
