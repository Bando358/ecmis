...
export default function TableRapportMedecine({
  ...
  const exportToPdf = async () => {
    ...
    try {
      ...
      const serviceDataMF = generateTableDataMF(tabServiceAutre);
      ...
      serviceDataMF.push(["SRV - Total service médecine générale", ...srvTotalMasc, ...srvTotalFem, srvGrandTotal]);
      autoTable(doc, {
        startY: currentY,
        head: headersMF,
        body: serviceDataMF,
      ...
      <Table className="border">
        <TableHeader className="bg-slate-100 border border-gray-300">
          <TableRow>
            ...
            <TableHead colSpan={4} className="font-semibold text-center border border-gray-300">
              Féminin
            </TableHead>
            <TableHead rowSpan={2} className="font-semibold border border-gray-300">
              Total
      ...
      <Table className="border">
        ...
        <TableBody>
          ...
          <TableRow className="font-bold bg-slate-200">
            <TableCell>SRV - Total service médecine générale</TableCell>
            {ageRanges.map((range, index) => (
