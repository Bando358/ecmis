...
import { Clinique, Region } from "@/lib/generated/prisma";
    ...
    const fetchData = async () => {
      ...
      if (
        ...
        for (let index = 0; index < tabId.length; index++) {
          const element = allClinique.filter((c) => c.id === tabId[index]);
          setClinic(element);
        }
      } else {
      ...
      >
        ...
        {selectedFile && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mt-4 bg-gradient-to-r from-green-600 to-yellow-500 bg-clip-text"
          >
                ...
                <div className="mt-6">
                  ...
                  {isVerifying && (
                    <div className="mt-4 text-center">
                      <p className="mt-4 bg-gradient-to-r from-green-600 to-yellow-500 bg-clip-text font-semibold">
                        ✅ Trouvés :{" "}
