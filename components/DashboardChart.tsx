...
import { Client, Planning, Visite } from "@/lib/generated/prisma";
import {
  Area,
  AreaChart,
  CartesianGrid,
    ...
    <div id="chart" className="w-full flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-4">
        {chartData.map((data, idx) => (
          <Card
            key={idx}
            className="group relative overflow-hidden border border-green-700 bg-gradient-to-br from-black via-zinc-900 to-green-950 text-white shadow-md hover:shadow-green-500/30 transition-all duration-500 rounded-2xl"
          >
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 bg-gradient-to-tr from-green-600/10 via-transparent to-green-900/20 pointer-events-none" />
      ...
      <Card className="group relative overflow-hidden border border-green-700 bg-gradient-to-br from-black via-zinc-900 to-green-950 text-white shadow-md hover:shadow-green-500/30 transition-all duration-500 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-green-300">Statut des Clients</CardTitle>
        ...
        <CardFooter className="flex-col items-start gap-2 text-sm">
          <div className="flex gap-2 leading-none font-medium text-green-300">
            Analyse des statuts clients <TrendingUp className="h-4 w-4" />
          </div>
          <div className="text-green-700 leading-none">
      ...
      <Card className="group relative overflow-hidden border border-green-700 bg-gradient-to-br from-black via-zinc-900 to-green-950 text-white shadow-md hover:shadow-green-500/30 transition-all duration-500 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-green-300">Motifs de Visite</CardTitle>
          <CardDescription className="text-green-700">
            Répartition des motifs de visite des clients
          </CardDescription>
        </CardHeader>
        <CardContent className="px-2 h-[180px] sm:px-6">
          {loading ? (
                ...
                <ChartTooltip
                  ...
                  content={({ active, payload, label }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-black/90 border border-green-700 rounded-lg p-3 shadow-lg">
      ...
      <Card className="group relative overflow-hidden border border-green-700 bg-gradient-to-br from-black via-zinc-900 to-green-950 text-white shadow-md hover:shadow-green-500/30 transition-all duration-500 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-green-300">Utilisateurs PF</CardTitle>
          <CardDescription className="text-green-700">
      ...
      <Card className="group relative overflow-hidden border border-green-700 bg-gradient-to-br from-black via-zinc-900 to-green-950 text-white shadow-md hover:shadow-green-500/30 transition-all duration-500 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-green-300">Types de Prestations</CardTitle>
          <CardDescription className="text-green-700">
                        ...
                        <div className="bg-black/90 border border-green-700 rounded-lg p-3 shadow-lg">
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            <div
                              ...
                              style={{ backgroundColor: payload[0].color }}
                            />
                            <span className="text-white">Nombre total : </span>
                            <span className="text-green-300 font-bold">
