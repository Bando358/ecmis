...
import { Client, Permission, TableName } from "@/lib/generated/prisma";
...
export default function ModifFormulaireClient({
  ...
  }, [modifClientId, idPrestataire, session]);
  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.CLIENT);
      ...
      {isVisible ? (
        <>
          ...
          <form
            ...
            className="space-y-4 max-w-[900px] mx-auto p-4 border rounded-md bg-stone-50 opacity-90"
          >
            <div className="grid grid-cols-2 gap-4 w-full">
              ...
              <div>
                ...
                <div className="flex relative m-[-5px]">
                  <Input
                    ...
                    readOnly
                  />
                  <span className="absolute right-1 top-[10px]">
        ...
        <div className="flex flex-col gap-2 max-w-md mx-auto">
          {!selectedClient ? (
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <span>
                  {`${new Date(selectedClient.dateNaissance).toLocaleDateString(
                    "fr-FR"
                  )} (${Math.floor(
                    (new Date().getTime() -
