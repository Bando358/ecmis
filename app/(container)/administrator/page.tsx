...
import { TableName } from "@/lib/generated/prisma";
...
export default function Administrator() {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find(
          (p) => p.table === TableName.ADMINISTRATION
        );
  ...
  return (
    <div>
      ...
      <div className="max-w-[900px] mx-auto relative flex flex-col justify-center p-4 rounded-md">
        <Card>
          <CardContent>
