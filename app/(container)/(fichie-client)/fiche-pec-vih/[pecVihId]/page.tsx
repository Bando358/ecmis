...
export default function PecVihPage({
  ...
  return (
    <div className="flex flex-col w-full justify-center max-w-[900px] mx-auto px-4 py-2 border rounded-md transition-width duration-300">
        ...
        >
          ...
          <Form {...form}>
            <form
              ...
              className="space-y-2 rounded-sm mx-auto px-4 py-2 bg-white shadow-md max-w-[350px]"
            >
              <FormField
