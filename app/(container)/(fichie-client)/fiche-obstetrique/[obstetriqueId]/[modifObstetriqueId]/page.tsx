  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.OBSTETRIQUE);
    ...
    const fetchData = async () => {
      ...
      if (oneObstetrique) {
        ...
        const visiteDate = result.find(
          (r) => r.id === oneObstetrique.obstIdVisite
        );
        ...
        setVisites(result.filter((r) => r.id === oneObstetrique.obstIdVisite)); // Use oneObstetrique instead of selectedObstetrique
