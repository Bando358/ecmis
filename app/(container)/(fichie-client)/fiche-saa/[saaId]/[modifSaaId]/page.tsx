  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (oneSaa) {
        ...
        const visiteDate = result.find((r) => r.id === oneSaa.saaIdVisite);
        ...
        setVisites(result.filter((r) => r.id === oneSaa.saaIdVisite));
        ...
        <>
          ...
          <Form {...form}>
            <form
              ...
              className="space-y-2 max-w-[400px] rounded-sm mx-auto px-4 py-2 bg-white shadow-md transition-all duration-300"
            >
