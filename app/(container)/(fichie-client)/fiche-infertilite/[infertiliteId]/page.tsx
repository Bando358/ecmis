  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.INFERTILITE);
              ...
              render={({ field }) => (
                <FormItem className=" px-4 pb-4">
                  <div className="text-xl font-bold flex justify-between items-center">
                    <FormLabel className="ml-4">Type de traitement:</FormLabel>
                    <RefreshCw
                      onClick={() => {
                  ...
                  >
                    ...
                    <SelectContent>
                      {allPrescripteur.map((prescipteur) => (
                        <SelectItem key={prescipteur.id} value={prescipteur.id}>
