  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.GROSSESSE);
    ...
    const fetchData = async () => {
      ...
      if (oneGrossesse) {
        ...
        const visiteDate = result.find(
          (r) => r.id === oneGrossesse.grossesseIdVisite
        );
        ...
        setVisites(
          result.filter((r) => r.id === oneGrossesse.grossesseIdVisite)
