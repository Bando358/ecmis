  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.PEC_VIH);
    ...
    <div className="flex flex-col w-full justify-center">
      ...
      <Form {...form}>
        <form
          ...
          className="space-y-4 max-w-[900px] mx-auto p-4 m-4 border rounded-md bg-emerald-50/20"
        >
          ...
          <div className="p-4 rounded-lg bg-sage-50/40 border border-sage-100">
            <h3 className="text-lg font-semibold mb-4 text-sage-800">Dates</h3>
          ...
          <div className="p-4 rounded-lg bg-mint-50/40 border border-mint-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-mint-700">Allaitement</FormLabel>
                    <Select
                      onValueChange={field.onChange}
                      value={field.value || ""}
                    >
          ...
          <div className="p-4 rounded-lg bg-celadon-50/40 border border-celadon-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-celadon-700">Glycémie</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        {...field}
