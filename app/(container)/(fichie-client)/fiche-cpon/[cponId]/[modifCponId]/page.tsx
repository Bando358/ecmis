  ...
  useEffect(() => {
    ...
    const fetchPermissions = async () => {
      try {
        ...
        const perm = permissions.find((p) => p.table === TableName.CPON);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (oneCpon) {
        ...
        const visiteDate = result.find((r) => r.id === oneCpon.cponIdVisite);
        ...
        setVisites(result.filter((r) => r.id === oneCpon.cponIdVisite)); // Use oneCpon instead of selectedCpon
